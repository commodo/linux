...
#include "./../../private/include/fpga9001_bf_tdd_dp_ctrl.h"
 ...
 * 
 */
int32_t fpga9001_TddDpCtrlEnableBitBfSet(adi_fpga9001_Device_t *device, 
                                          ...
                                          uint8_t bfValue)
{
        ...
        (bfValue > 1U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         bfValue,
                         "Invalid fpga9001_TddDpCtrlEnableBitBfSet parameter");
            ...
            (baseAddr != FPGA9001_BF_TX_DP_CTRL_01))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9001_TddDpCtrlEnableBitBfSet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
 ...
 * 
 */
int32_t fpga9001_TddDpCtrlEnableBitBfGet(adi_fpga9001_Device_t *device, 
                                         fpga9001_BfTddDpCtrlChanAddr_e baseAddr, 
                                          uint8_t *bfValue)
{
    int32_t recoveryAction = ADI_COMMON_ACT_NO_ACTION;
            ...
            (baseAddr != FPGA9001_BF_TX_DP_CTRL_01))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9001_TddDpCtrlEnableBitBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9001_BITFIELD_ADDR_CHECK */ 
 ...
 * 
 */
int32_t fpga9001_TddDpCtrlStartValueBfSet(adi_fpga9001_Device_t *device, 
                                          fpga9001_BfTddDpCtrlChanAddr_e baseAddr, 
                                           uint32_t bfValue)
{
    int32_t recoveryAction = ADI_COMMON_ACT_NO_ACTION;
        ...
        (bfValue > 4294967295U))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM, 
                         bfValue,
                         "Invalid fpga9001_TddDpCtrlStartValueBfSet parameter");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9001_BITFIELD_VALUE_CHECK */
            ...
            (baseAddr != FPGA9001_BF_TX_DP_CTRL_01))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9001_TddDpCtrlStartValueBfSet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9001_BITFIELD_ADDR_CHECK */ 
 ...
 * 
 */
int32_t fpga9001_TddDpCtrlStartValueBfGet(adi_fpga9001_Device_t *device, 
                                          fpga9001_BfTddDpCtrlChanAddr_e baseAddr, 
                                           uint32_t *bfValue)
{
    int32_t recoveryAction = ADI_COMMON_ACT_NO_ACTION;
            ...
            (baseAddr != FPGA9001_BF_TX_DP_CTRL_01))
    {
        ADI_ERROR_REPORT(&device->common, 
                         ...
                         ADI_COMMON_ACT_ERR_CHECK_PARAM,
                         baseAddr, 
                         "Invalid fpga9001_TddDpCtrlStartValueBfGet Address");
        ADI_ERROR_RETURN(device->common.error.newAction);
    }
#endif /* FPGA9001_BITFIELD_ADDR_CHECK */ 
