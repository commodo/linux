...
/* FIXME: Vivek - Need to confirm ARM support of these objectIDs in navassa */
...
#define ADRV9001_ARM_OBJECTID_RAM_DRIVE_AND_CAPTURE_CONFIG  0x95
#define ADRV9001_ARM_OBJECTID_RAM_DRIVE_AND_CAPTURE_START   0x96
#define ADRV9001_ARM_OBJECTID_BBDC_TEST_DISABLE             0x97
#define ADRV9001_ARM_OBJECTID_CFG_RADIO_EVENT               0xA1

/* ARM memory */
#define ADRV9001_ADDR_ARM_START_PROG					0x01000000
/* FIXME: Vivek - Need to confirm the end address of program and data memory */
#define ADRV9001_ADDR_ARM_END_PROG						    0x0103FFFF
#define ADRV9001_ADDR_ARM_START_DATA					    0x20000000
#define ADRV9001_ADDR_ARM_END_DATA						    0x20047FFF
...
/* FIXME: Vivek - Need to confirm with ARM firmware team about mailbox for FH, RUNINIT */
...
#define ADRV9001_MAILBOX_CHANNEL_RX1                        0x01
#define ADRV9001_MAILBOX_CHANNEL_RX2                        0x02
#define ADRV9001_MAILBOX_CHANNEL_TX1                        0x04
#define ADRV9001_MAILBOX_CHANNEL_TX2                        0x08
#define ADRV9001_MAILBOX_CHANNEL_ORX1                       0x10
#define ADRV9001_MAILBOX_CHANNEL_ORX2                       0x20
