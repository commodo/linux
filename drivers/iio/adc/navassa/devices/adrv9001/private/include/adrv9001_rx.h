...
#include "../devices/adrv9001/private/include/adrv9001_bf_nvs_regmap_rxb.h"
//#include "../devices/adrv9001/private/include/adrv9001_bf_analog_rx_mem_map.h"
#include "../devices/adrv9001/private/include/adrv9001_reg_addr_macros.h"
...
/**
* \brief Checks whether the RSSI status read configuration values are within valid range
*        adrv9001_RxRssiRead() API.
*
* \param device         Pointer to the ADRV9001 data structure
* \param rxRssiStatus   Pointer to the structure (of type adi_adrv9001_RxRssiStatus_t) 
*                       where the RSSI status is stored for the given RX channel
* \param rxChannel      Rx channel for which the RSSI status to be read
*
* \retval ADI_COMMON_ACT_WARN_RESET_LOG  Recovery action for log reset
* \retval ADI_COMMON_ACT_ERR_CHECK_PARAM Recovery action for bad parameter check
* \retval ADI_COMMON_ACT_NO_ACTION       Function completed successfully, no action required
*/
int32_t adrv9001_RxRssiReadValidate(adi_adrv9001_Device_t *device,
