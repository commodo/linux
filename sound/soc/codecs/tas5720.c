				    ...
				    int slots, int slot_width)
{
	...
	/* Enable manual TDM slot selection (instead of I2C ID based). This is not applicable to TAS5720A-Q1. */
...
static int tas5720_codec_probe(struct snd_soc_component *component)
{
	...
	/* Set Bit 7 in TAS5720_ANALOG_CTRL_REG to 1, as suggested by the manufacturer */
	switch (tas5720->devtype) {
	case TAS5720A_Q1:
		ret = snd_soc_component_update_bits(component, TAS5720_ANALOG_CTRL_REG,
					TAS5720_Q1_RESERVED7_BIT, TAS5720_Q1_RESERVED7_BIT);
		break;
	default:
		break;
	}
